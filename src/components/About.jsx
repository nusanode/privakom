const About = () => {
  return (
    <section
      id="about"
      className="py-20 lg:py-32 bg-white relative w-full overflow-hidden border-t-[3px] border-dark"
    >
        ...
        <div className="lg:w-1/2 w-full py-8 mt-12 lg:mt-0 z-10">
          ...
          <ul className="space-y-4 mb-14">
            <li className="flex items-center gap-4 border-[2px] border-dark p-4 bg-white hover:bg-primary transition-colors cursor-default group/list">
              ...
              <span className="text-dark font-bold uppercase tracking-widest text-sm">
          ...
          <a
            href="#courses"
            className="inline-flex items-center gap-4 bg-primary border-[3px] border-dark text-dark font-bold px-10 py-5 uppercase tracking-widest shadow-[6px_6px_0px_0px_rgba(17,17,17,1)] hover:shadow-[2px_2px_0px_0px_rgba(17,17,17,1)] hover:translate-y-1 hover:translate-x-1 transition-all"
          >
            Learn More
            <svg
              className="w-5 h-5"
