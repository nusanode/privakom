...
const Testimonials = () => {
  ...
  return (
    <section
      id="students"
      className="py-24 bg-white border-t-[3px] border-dark w-full overflow-hidden"
    >
        ...
        <div className="relative w-full flex overflow-x-hidden group">
          ...
          <div className="flex w-max animate-marquee hover:[animation-play-state:paused] py-4">
            {doubledStudents.map((student, index) => (
              ...
              >
                <svg
                  className="w-20 h-20 text-dark opacity-10 absolute top-6 right-6 transition-transform duration-500 group-hover/card:scale-110 pointer-events-none"
                  fill="currentColor"
                  viewBox="0 0 32 32"
                >
                ...
                <div className="flex items-center gap-5 mt-auto pointer-events-none border-t-[3px] border-dark pt-6">
                  ...
                  />
                  <div>
                    <h4 className="font-black font-serif text-dark text-xl uppercase tracking-tight">
                      {student.name}
                    </h4>
                    <p className="text-xs text-dark font-bold uppercase tracking-widest mt-1">
                      {student.role}
                    </p>
                  </div>
                </div>
