    ...
    <section className="px-6 lg:px-12 max-w-8xl mx-auto relative z-20 -mt-16 lg:-mt-24 pb-20 w-full">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
        ...
        >
          ...
          <svg
            className="absolute bottom-[-20px] right-[-20px] w-48 h-48 text-dark opacity-10 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        >
          <div className="w-1/2 p-6 lg:p-8 flex flex-col justify-center h-full border-r-[3px] border-dark z-10 bg-white">
            <h3 className="text-5xl font-black font-serif text-dark mb-2">
              20+
            </h3>
            <p className="text-dark font-bold uppercase tracking-widest text-xs mb-6 leading-relaxed">
              Learning
              <br />
              Activities
            </p>
            <a
              href="#courses"
              className="text-dark font-black uppercase tracking-widest text-xs hover:bg-primary inline-flex items-center gap-2 w-max p-2 border-[2px] border-transparent hover:border-dark transition-all outline-none"
            >
              Join Now
              <svg
        ...
        >
          <div>
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-6xl font-black font-serif tracking-tight text-white">
                50+
              </h3>
            ...
            <p className="text-sm font-bold text-white uppercase tracking-widest mt-6">
              Expert Instructors
            </p>
          </div>
