...
const Courses = () => {
  ...
  const handleDaftarClick = () => {
    const tangerangLocation = contactData.locations.find(
      (loc) => loc.id === "tng",
    );

    const rawPhoneNumber = tangerangLocation
      ? tangerangLocation.whatsapp
      : contactData.locations[0].whatsapp;
  ...
  return (
    <section
      id="courses"
      className="px-6 lg:px-12 max-w-8xl mx-auto py-24 w-full relative bg-white border-t-[3px] border-dark"
    >
      <div className="flex flex-col md:flex-row items-end justify-between mb-16">
        <div className="mb-8 md:mb-0">
          <div className="flex items-center gap-3 mb-4">
            <div className="h-[3px] w-8 bg-dark"></div>
            <span className="text-dark font-bold tracking-widest text-sm uppercase">
              Discover Your Path
            </span>
          </div>
      ...
      {displayedCourses.length > 0 ? (
            ...
            {displayedCourses.map((course, index) => (
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow bg-white">
                  <h3 className="text-2xl font-black font-serif text-dark mb-4 line-clamp-2 leading-tight">
                    {course.title}
                  </h3>
                  <p className="text-dark font-light text-lg mb-8 line-clamp-2 flex-grow">
                    {course.description}
                  </p>
            ...
            <table className="w-full text-left border-collapse whitespace-nowrap min-w-[800px]">
              <thead>
                <tr className="bg-primary text-dark border-b-[3px] border-dark">
                  <th className="py-5 px-6 font-black uppercase tracking-widest w-16 text-center border-r-[3px] border-dark">
                    No
                  </th>
                  <th className="py-5 px-6 font-black uppercase tracking-widest border-r-[3px] border-dark">
                    Program Kursus
                  </th>
                  <th className="py-5 px-6 font-black uppercase tracking-widest border-r-[3px] border-dark">
                    Kategori
                  ...
                  <th className="py-5 px-6 font-black uppercase tracking-widest text-center">
                    Aksi
                  </th>
                </tr>
              </thead>
        ...
        <div className="col-span-full py-24 flex flex-col items-center justify-center text-center border-[3px] border-dark bg-gray-50 shadow-[8px_8px_0px_0px_rgba(17,17,17,1)]">
          ...
          <h3 className="text-3xl font-black font-serif text-dark mb-4 uppercase">
            No Courses Found
          </h3>
          ...
          <button
            onClick={() => setSearchTerm("")}
            className="mt-8 bg-dark text-white font-bold uppercase tracking-widest px-8 py-4 hover:bg-primary hover:text-dark border-[3px] border-transparent hover:border-dark transition-colors"
          >
            Clear Search
          </button>
        </div>
      ...
      {selectedCourse && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-dark/90 backdrop-blur-sm p-4 md:p-8 overflow-y-auto"
          role="dialog"
          aria-modal="true"
        >
          <div
          ...
          <div className="bg-white w-full max-w-3xl relative z-10 border-[4px] border-dark shadow-[16px_16px_0px_0px_rgba(252,227,0,1)] animate-[fadeIn_0.2s_ease-out] my-auto">
            ...
            <div className="p-8 lg:p-10">
              ...
              <h4 className="font-black text-xl text-dark mb-4 uppercase tracking-widest">
                Deskripsi Program:
              </h4>
              ...
              <div className="bg-gray-100 border-l-[6px] border-dark p-6 mb-10">
                <p className="text-dark font-medium text-lg italic">
                  "Untuk informasi harga kelas reguler, weekend, maupun private,
                  silakan hubungi tim admin kami melalui WhatsApp."
                </p>
              </div>
